...
export const PROJECTS: ProjectItem[] = [
  {
    ...
    description:
      'Nuestra escuela de Taekwondo donde formamos atletas desde las bases hasta la alta competencia internacional.',
    collaborations: [
    ...
    whatsappMessage:
      'Hola, vi la campaña Rumbo a España 2026 y me interesa colaborar con la Escuela de Taekwondo.',
  },
  {
    id: 'hes1994',
    name: 'HES1994',
    ...
    description:
      'Tienda especializada en stickers y productos personalizados para marcas, deportistas y eventos.',
    collaborations: [
    ...
    whatsappMessage:
      'Hola, vi la campaña Rumbo a España 2026 y me interesa solicitar productos personalizados con HES1994.',
  },
  {
    id: 'aim',
    name: 'AIM',
    ...
    description:
      'Estrategias de comunicación digital, crecimiento y presencia web integral para marcas y profesionales.',
    collaborations: [
    ...
    whatsappMessage:
      'Hola, vi la campaña Rumbo a España 2026 y me gustaría cotizar servicios digitales con AIM.',
  },
  {
    id: 'tech-services',
    ...
    description:
      'Soluciones de ingeniería de software a medida para empresas, startups y proyectos que necesitan escalar.',
    collaborations: [
    ...
    whatsappMessage:
      'Hola, vi la campaña Rumbo a España 2026 y me interesa contratar servicios de desarrollo y software.',
  },
  {
    id: 'scalinky',
    name: 'Scalinky',
    ...
    description:
      'Herramienta y producto digital enfocado en escalabilidad y soluciones tecnológicas directas.',
    collaborations: [
    ...
    whatsappMessage:
      'Hola, vi la campaña Rumbo a España 2026 y quiero conocer más sobre Scalinky.',
  },
];
